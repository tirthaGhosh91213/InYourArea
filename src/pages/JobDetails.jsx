...
export default function JobDetails() {
  ...
  const fetchJob = async () => {
    try {
      ...
      const res = await axios.get(
        `https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/jobs`,
        {
  ...
  const fetchComments = async () => {
    try {
      const res = await axios.get(
        `https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/comments/jobs/${id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
