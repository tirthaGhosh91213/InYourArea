...
function LogIn() {
  ...
  const GOOGLE_AUTH_URL = 'https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/oauth2/authorization/google';
...
// }, [location.search, navigate]);
  ...
  const handleSendOtp = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSignin = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/forgot-password",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://rehabilitation-cost-additionally-pci.trycloudflare.com/api/v1/auth/reset-password",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
