      ...
      {showShareMenu && (
        <>
          ...
          <motion.div
            ...
            className="absolute top-full mt-2 right-0 bg-white rounded-2xl shadow-2xl p-4 z-50 border border-gray-200"
            style={{ minWidth: "280px" }}
          >
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-800">Share this news</h3>
              <button
                onClick={() => setShowShareMenu(false)}
            ...
            <div className="flex gap-3 justify-center">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => {
                  const shareUrl = `https://api.jharkhandbiharupdates.com/api/v1/share/localnews/${id}`;
                  window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`, '_blank');
                  setShowShareMenu(false);
                }}
                className="w-12 h-12 bg-[#1877F2] text-white rounded-full flex items-center justify-center hover:bg-[#145dbf] transition"
              ...
              <motion.button
                ...
                onClick={() => {
                  const shareUrl = `https://api.jharkhandbiharupdates.com/api/v1/share/localnews/${id}`;
                  window.open(`https://wa.me/?text=${encodeURIComponent(plainTitle + ' - ' + shareUrl)}`, '_blank');
                  setShowShareMenu(false);
                }}
                className="w-12 h-12 bg-[#25D366] text-white rounded-full flex items-center justify-center hover:bg-[#1da851] transition"
              ...
              <motion.button
                ...
                onClick={() => {
                  const shareUrl = `https://api.jharkhandbiharupdates.com/api/v1/share/localnews/${id}`;
                  window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(plainTitle)}&url=${encodeURIComponent(shareUrl)}`, '_blank');
                  setShowShareMenu(false);
                }}
              ...
              <motion.button
                ...
                className="w-12 h-12 bg-gray-600 text-white rounded-full flex items-center justify-center hover:bg-gray-700 transition"
                title="Copy Link"
              >
