            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full px-4 py-2 shadow-lg transition"
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  ...
                  <motion.button
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-2xl hover:bg-blue-50 transition group"
                    title="Share on Facebook"
                  >
                    <div className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition">
                      <svg
                  ...
                  <motion.button
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-2xl hover:bg-gray-100 transition group"
                    title="Share on X (Twitter)"
                  >
                    <div className="w-14 h-14 bg-black rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition">
                      <svg
                  ...
                  <motion.button
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-2xl hover:bg-green-50 transition group"
                    title="Share on WhatsApp"
                  >
                    <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition">
                      <svg
                        className="w-7 h-7 text-white"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                  ...
                  <motion.button
                    ...
                    title="Copy link"
                  >
                    <div className="w-14 h-14 bg-gray-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition">
                      {linkCopied ? (
