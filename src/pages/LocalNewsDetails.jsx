                ...
                <div className="relative">
                  ...
                  <AnimatePresence>
                    {showShareMenu && (
                      ...
                      >
                        <div className="bg-blue-600 rounded-full shadow-2xl px-3 py-3 flex items-center gap-3">
                          {/* Close Button */}
                          <motion.button
                            whileHover={{ scale: 1.1, rotate: 90 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={() => setShowShareMenu(false)}
                            className="w-12 h-12 bg-gray-900 hover:bg-gray-800 rounded-full flex items-center justify-center text-white transition"
                            title="Close"
                          >
                            <X size={20} />
                          </motion.button>
                          ...
                          <motion.button
                            ...
                            className="w-12 h-12 flex items-center justify-center text-white hover:bg-blue-700 rounded-full transition"
