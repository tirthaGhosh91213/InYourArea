...
export default function UserDashboard() {
  ...
  const fetchProfile = async () => {
    try {
      const res = await axios.get("https://miami-only-great-buf.trycloudflare.com/api/v1/user/profile", {
        headers,
      });
  ...
  const fetchStats = async () => {
    try {
      const res = await axios.get("https://miami-only-great-buf.trycloudflare.com/api/v1/user/stats", {
        headers,
      });
  ...
  const fetchContent = async () => {
    try {
      const res = await axios.get(
        "https://miami-only-great-buf.trycloudflare.com/api/v1/user/my-content",
        { headers }
      );
  ...
  const fetchComments = async () => {
    try {
      const res = await axios.get(
        "https://miami-only-great-buf.trycloudflare.com/api/v1/user/my-comments",
        { headers }
      );
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await axios.put(
        "https://miami-only-great-buf.trycloudflare.com/api/v1/user/profile",
        formData,
        { headers }
      );
      setProfile(res.data.data);
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      await axios.put(
        "https://miami-only-great-buf.trycloudflare.com/api/v1/user/profile/image",
        formDataObj,
        {
  ...
  const handleView = async (type, id) => {
    try {
      let url = "";
      if (type === "events") url = `https://miami-only-great-buf.trycloudflare.com/api/v1/events/${id}`;
      else if (type === "jobs") url = `https://miami-only-great-buf.trycloudflare.com/api/v1/jobs/${id}`;
      else if (type === "community")
        url = `https://miami-only-great-buf.trycloudflare.com/api/v1/community/${id}`;
      else if (type === "localNews")
        url = `https://miami-only-great-buf.trycloudflare.com/api/v1/district-news/details/${id}`;
  ...
  const handleDelete = async () => {
    ...
    try {
      let url = "";
      if (type === "events") url = `https://miami-only-great-buf.trycloudflare.com/api/v1/events/${id}`;
      if (type === "jobs") url = `https://miami-only-great-buf.trycloudflare.com/api/v1/jobs/${id}`;
      if (type === "community")
        url = `https://miami-only-great-buf.trycloudflare.com/api/v1/community/${id}`;
      if (type === "localNews")
        url = `https://miami-only-great-buf.trycloudflare.com/api/v1/district-news/${id}`;
  ...
  const handleUpdateNews = async () => {
    ...
    try {
      await axios.put(
        `https://miami-only-great-buf.trycloudflare.com/api/v1/district-news/${editNewsId}`,
        editNewsData,
        { headers }
      );
